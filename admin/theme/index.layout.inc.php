...
<html lang="en">
<head>
    <title>Admin | TestTemplate CMS</title>
    ...
    <link rel="stylesheet" href="theme/css/admin.layout.css" type="text/css">
    <link rel="stylesheet" href="theme/css/admin.form.css" type="text/css">    
</head>
<body>

<div id="AdminHeader">
    <h1 class="content">GolemCMS</h1>
    <p>You are currently logged in as <span class="LoginName"><?php echo $LoginName; ?></span> | <a href="index.php?page=logout">Logout</a> | <a href="#">View Site</a></p>
</div>
